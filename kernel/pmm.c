...
/* Disk pad is still KERNEL_SECTORS 256; TASK_MAX 16 grows .bss past that.
 * Reserve 272 sectors of RAM so the PMM bitmap starts after .bss. */
#define KERNEL_SIZE (272ull * 512ull)
