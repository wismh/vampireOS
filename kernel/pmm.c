...
/* Disk pad is still KERNEL_SECTORS 256; the 16-slot table plus per-task
 * tick counters grow .bss past 272 sectors. Reserve 280 so the bitmap
 * starts after .bss. */
#define KERNEL_SIZE (280ull * 512ull)
