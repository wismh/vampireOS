...
- No job control (`fg` / `bg` / `jobs`), no FAT16, no userland bitmap font / mouse, no AHCI/VirtIO, no serial console, no SMP, no networking, no signals beyond kill/Ctrl+C.
