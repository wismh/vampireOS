...
- No job control (`fg` / `bg` / `jobs`), no FAT16, no cursor/prompt on FB / mouse, no AHCI/VirtIO, no serial console, no SMP, no networking, no signals beyond kill/Ctrl+C.
